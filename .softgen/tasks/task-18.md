...
## Checklist
- [x] Inspect Issue Stamp customer search query and compare with working Customers page query
- [x] Inspect Staff Loyalty Programs query and business membership resolution
- [x] Inspect RLS policies for customers, customer_loyalty_cards, loyalty_programs, stamp_transactions, business_users, and businesses
- [x] Identify exact failing layer for Owner Issue Stamp customer search

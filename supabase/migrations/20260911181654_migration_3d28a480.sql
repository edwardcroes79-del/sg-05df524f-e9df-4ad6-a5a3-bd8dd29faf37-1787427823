DROP FUNCTION IF EXISTS public.redeem_reward_by_qr_tx(uuid, uuid, uuid);
...
BEGIN
    ...
    -- Delegate to the existing atomic transaction logic with proper named parameters (2 arguments)
